...
```{r}
pred_adult_sbly_lower <- variable_coefficient_lengths(sbly_small, sbly_adults, sbly_adults$NPGO_pos)
...
```{r}
pred_adult_sbly_upper <- variable_coefficient_lengths(sbly_large, sbly_adults, sbly_adults$NPGO_pos)
...
```{r}
pred_adult_widw_lower <- variable_coefficient_lengths(widw_small, widw_adults, widw_adults$NPGO_pos)
...
```{r}
pred_adult_widw_upper <- variable_coefficient_lengths(widw_large, widw_adults, widw_adults$NPGO_pos)
