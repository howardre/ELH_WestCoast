...
hindcast_match <- function(data, roms, a, b){
  ...
  data$ssh_anom <- as.data.frame(roms)[c(data$nn.idx), 21] # Match nearest temp
...
yoy_anch <- hindcast_match(merge_anch, hindcast_anom, 36, 37)
yoy_dab <- hindcast_match(merge_dab, hindcast_anom, 37, 38)
yoy_hake <- hindcast_match(merge_hake, hindcast_anom, 37, 38)
yoy_sbly <- hindcast_match(merge_sbly, hindcast_anom, 37, 38)
yoy_widw <- hindcast_match(merge_widw, hindcast_anom, 37, 38)
```
