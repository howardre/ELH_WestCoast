...
widow_sp <- filter(other_sp, species == 597, std_length > 16 & std_length < 65 & !is.na(std_length))
sbly_sp <- filter(other_sp, species == 604, std_length > 10 & std_length < 79 & !is.na(std_length))
dab_sp <- filter(other_sp, species == 147, year > 2010, std_length > 15 & std_length < 56 & !is.na(std_length))
hake_sp <- filter(other_sp, species == 382, std_length > 14 & std_length < 82 & !is.na(std_length))
anch_sp <- filter(anch_sp, std_length > 20 & std_length < 86)
