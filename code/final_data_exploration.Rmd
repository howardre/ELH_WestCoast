...
```{r}
yoy_anch <- add_roms(merge_anch)
yoy_widw <- add_roms(merge_widw)
yoy_sbly <- add_roms(merge_sbly)
yoy_dab <- add_roms(merge_dab)
yoy_hake <- add_roms(merge_hake)
yoy_squid <- add_roms(merge_squid)
```
