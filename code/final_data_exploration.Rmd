...
merge_lengths <- function(catch, subset, ctd_means){
  data <- merge(catch,
...
yoy_anch <- merge_lengths(anch_catch, anch_subset, ctd_means)
yoy_widw <- merge_lengths(widow_catch, widow_subset, ctd_means)
yoy_sbly <- merge_lengths(sbly_catch, sbly_subset, ctd_means)
yoy_dab <- merge_lengths(dab_catch, dab_subset, ctd_means)
yoy_hake <- merge_lengths(hake_catch, hake_subset, ctd_means)
```
