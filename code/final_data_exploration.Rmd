...
size_calc <- function(sp, size){
  size_filter <- sp %>% filter(num_measured > 0)
  sizes <- mutate(size_filter, size_class = case_when(std_length <= size ~ "small",
...
widow_subset <- size_calc(widow_sp, 31) # reevaluate this one
