...
merge_lengths <- function(catch, subset){
  data <- merge(catch,
...
```{r}
# Add CTD data
# Match to haul level data (not currently possible, no ctd_index available)
yoy_anch <- merge_lengths(anch_catch, anch_subset)
yoy_widw <- merge_lengths(widow_catch, widow_subset)
yoy_sbly <- merge_lengths(sbly_catch, sbly_subset)
yoy_dab <- merge_lengths(dab_catch, dab_subset)
yoy_hake <- merge_lengths(hake_catch, hake_subset)
```
