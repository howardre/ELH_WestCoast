...
Load data
```{r}
ctds <- read.csv(here::here('data', 'Prerecruit_env.csv'))[, -1]
...
avg_ctds$date <- as.numeric(format(as.Date(avg_ctds$date, format = "%Y-%m-%d"), "%m%d%Y"))
```
